<?php
/**
 * WPImgTagAddWidthAndHeightAttrAddFilter
 *
 ...
 * @since 5.5.0
 */
abstract class WPImgTagAddWidthAndHeightAttrAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'wp_img_tag_add_width_and_height_attr';
