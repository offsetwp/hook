<?php
/**
 * WPRestRequestAfterCallbacksAddFilter
 *
 ...
 * @since 4.7.0
 */
abstract class WPRestRequestAfterCallbacksAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'rest_request_after_callbacks';
