<?php
/**
 * WPHttpsLocalSslVerifyAddFilter
 *
 ...
 */
abstract class WPHttpsLocalSslVerifyAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'https_local_ssl_verify';
