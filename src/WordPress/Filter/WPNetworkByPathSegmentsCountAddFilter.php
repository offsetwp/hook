<?php
/**
 * WPNetworkByPathSegmentsCountAddFilter
 *
 ...
 * @since 3.9.0
 */
abstract class WPNetworkByPathSegmentsCountAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'network_by_path_segments_count';
