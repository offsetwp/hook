<?php
/**
 * WPEnableUpdateServicesConfigurationAddFilter
 *
 ...
 * @since 3.0.0
 */
abstract class WPEnableUpdateServicesConfigurationAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'enable_update_services_configuration';
