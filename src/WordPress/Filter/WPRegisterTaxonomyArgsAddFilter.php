<?php
/**
 * WPRegisterTaxonomyArgsAddFilter
 *
 ...
 * @since 4.4.0
 */
abstract class WPRegisterTaxonomyArgsAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'register_taxonomy_args';
