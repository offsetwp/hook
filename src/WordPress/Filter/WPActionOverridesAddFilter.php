 ...
 * @since 5.7.0
 */
abstract class WPActionOverridesAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = '{$action}_overrides';
	 ...
	 */
	abstract public function execute( $overrides, $file );
}
