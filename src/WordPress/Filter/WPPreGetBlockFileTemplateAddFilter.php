<?php
/**
 * WPPreGetBlockFileTemplateAddFilter
 *
 ...
 * @since 5.9.0
 */
abstract class WPPreGetBlockFileTemplateAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'pre_get_block_file_template';
