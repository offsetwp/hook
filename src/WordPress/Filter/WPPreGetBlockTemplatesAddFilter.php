<?php
/**
 * WPPreGetBlockTemplatesAddFilter
 *
 ...
 * @since 5.9.0
 */
abstract class WPPreGetBlockTemplatesAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'pre_get_block_templates';
	 ...
	 */
	abstract public function execute( $block_templates, $query, $template_type );
}
