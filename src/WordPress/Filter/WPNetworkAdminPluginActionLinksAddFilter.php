<?php
/**
 * WPNetworkAdminPluginActionLinksAddFilter
 *
 ...
 * @since 3.1.0
 */
abstract class WPNetworkAdminPluginActionLinksAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'network_admin_plugin_action_links';
