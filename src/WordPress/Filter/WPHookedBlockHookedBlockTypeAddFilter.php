<?php
/**
 * WPHookedBlockHookedBlockTypeAddFilter
 *
 ...
 * @since 6.5.0
 */
abstract class WPHookedBlockHookedBlockTypeAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'hooked_block_{$hooked_block_type}';
