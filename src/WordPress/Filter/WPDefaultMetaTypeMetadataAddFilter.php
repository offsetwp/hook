<?php
/**
 * WPDefaultMetaTypeMetadataAddFilter
 *
 ...
 * @since 5.5.0
 */
abstract class WPDefaultMetaTypeMetadataAddFilter extends \Offsetwp\Hook\Support\AddFilter {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'default_{$meta_type}_metadata';
	 ...
	 *
	 * @param mixed $value The value to return, either a single metadata value or an array of values depending on the value of <code>$single</code>.
