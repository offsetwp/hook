<?php
/**
 * WPRestInsertNavMenuItemAddAction
 *
 ...
 * @since 5.9.0
 */
abstract class WPRestInsertNavMenuItemAddAction extends \Offsetwp\Hook\Support\AddAction {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'rest_insert_nav_menu_item';
