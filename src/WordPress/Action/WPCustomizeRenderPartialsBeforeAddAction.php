<?php
/**
 * WPCustomizeRenderPartialsBeforeAddAction
 *
 ...
 * @since 4.5.0
 */
abstract class WPCustomizeRenderPartialsBeforeAddAction extends \Offsetwp\Hook\Support\AddAction {
	/**
	 * The name of the action to add the callback to.
	 *
	 * @var string
	 */
	public string $hook_name = 'customize_render_partials_before';
